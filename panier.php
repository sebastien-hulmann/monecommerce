...
if (isset($_POST['payer'])) {
    for ($i = 0; $i < count($_SESSION['panier']['id_produit']); $i++) {
        ...
        if ($produit['stock'] < $_SESSION['panier']['quantite'][$i]) {
            ...
            if ($produit['stock'] > 0) {
                $contenu .= '<div class="erreur">la quantité du produit ' . $_SESSION['panier']['id_produit'][$i] . ' à été réduite car notre stock était insuffisant, veuillez vérifier vos achats.</div>';
